      ...
      <TableCell align="right">
        ...
        >
          <Typography variant="h6">
            {txnButtonTextGeneralPending(pendingTransactions, "redeem_bond_" + bondName, "Claim and AutoAge")}
          </Typography>
        </Button>
      </TableCell>
    </TableRow>
  ...
  return (
    <Box id={`${bondName}--claim`} className="claim-bond-data-card bond-data-card" style={{ marginBottom: "30px" }}>
      ...
      <Box display="flex" justifyContent="space-around" alignItems="center" className="claim-bond-card-buttons">
        ...
        >
          <Typography variant="h5">
            {txnButtonTextGeneralPending(pendingTransactions, "redeem_bond_" + bondName, "Claim All and AutoAge")}
          </Typography>
        </Button>
      </Box>
    </Box>
