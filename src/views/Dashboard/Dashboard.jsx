...
import { Paper,  Typography, Box, Zoom, Container, useMediaQuery, Grid } from "@material-ui/core";
    ...
    <>
      ...
      {!address ? (
        <div className="get-start-main mt-5">
          <div className="new-here d-flex align-items-center justify-content-between w-100">
              <p className="mb-0">Are you new here?</p>
              <div className="btn-100 d-flex align-items-center gap-3">
                <Button className="game-btn px-5">Game docs</Button>
                <Button className="start-btn px-5" onClick={() => {
                  getStartModalShow(),
                    setModalNumber(1)
                }}>Get started</Button>
              </div>
        ...
        {modalNumber === 3 &&
          <Modal.Body className=" modal2">
            ...
            <div className="d-flex align-items-center">
              <Button><img src={require('../../assets/images/left-side.png').default} alt="" /></Button>
              <div className="slider">
                <img src={require('../../assets/images/slide1.png').default} alt="" />
              </div>
              <Button><img src={require('../../assets/images/right-side.png').default} alt="" /></Button>
            </div>
