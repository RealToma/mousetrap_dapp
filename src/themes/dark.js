...
const darkTheme = {
  ...
  gold: "#ebc50c",
  gray: "#ebc50c",
  textHighlightColor: "#bffffd",
  backgroundColor: "rgb(40,42,41,1)",
  background: `
  radial-gradient(circle, rgba(40,42,41,0.8048263250612745) 0%, rgba(13,17,15,1) 100%)
    `,
  paperBg: "rgba(54, 56, 64, 0.4)",
  modalBg: "#24242699",
  popoverBg: "rgba(54, 56, 64, 0.99)",
  menuBg: "#75807d",
  backdropBg: "rgba(9, 48, 31, 0.5)",
  largeTextColor: "#F4D092",
  activeLinkColor: "#3ce8a6",
  activeLinkSvgColor:
  ...
  primaryButtonBG: "#0e6343",
  primaryButtonHoverBG: "transparent",
  secondaryButtonHoverBG: "rgba(54, 56, 64, 1)",
  outlinedPrimaryButtonHoverBG: "#F8CC82",
  outlinedPrimaryButtonHoverColor: "#00ffd0",
